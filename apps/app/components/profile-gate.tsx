  ...
  return (
    <div className="pg-root">
      <div className="pg-card">
        ...
        <p className="pg-copy">
          Your passkey was registered before we started collecting contact info. Duffel needs a
          valid email and E.164 phone for every booking. Add them once — we'll keep them on this
          device next to your passkey.
        </p>
        ...
        <button className="pg-primary" onClick={save} disabled={!canSave}>
