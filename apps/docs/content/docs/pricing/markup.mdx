...
- Address (testnet): [`0x640e15B2B7cBa421c93dA1514f8E6Ba3e11f8515`](https://testnet.arcscan.app/address/0x640e15B2B7cBa421c93dA1514f8E6Ba3e11f8515) (UUPS proxy). Override locally via `ARC_ESCROW_ADDRESS` / `NEXT_PUBLIC_SENDERO_GUEST_ESCROW`.
- ABI: [`packages/sendero-guest`](https://github.com/tcxcx/sendero/blob/main/packages/sendero-guest/src/index.ts) (`SENDERO_GUEST_ESCROW_ABI`).
