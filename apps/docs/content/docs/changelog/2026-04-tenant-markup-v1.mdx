...
- **v1.0.0 snapshot pinned.** Old spec preserved at [`/openapi/v1.0.0.json`](https://docs.sendero.travel/openapi/v1.0.0.json) for clients that need the previous shape during a phased rollout. Live spec stays at [`/api/openapi.json`](https://app.sendero.travel/api/openapi.json).
