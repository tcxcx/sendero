...
See the [README](https://github.com/criptopoeta/arc#business-model)
...
Sendero wraps this in [`apps/app/lib/api-key-auth.ts::resolveTenantFromApiKey()`](https://github.com/criptopoeta/arc/blob/main/apps/app/lib/api-key-auth.ts),
...
[`apps/app/app/api/webhooks/clerk/route.ts`](https://github.com/criptopoeta/arc/blob/main/apps/app/app/api/webhooks/clerk/route.ts)
