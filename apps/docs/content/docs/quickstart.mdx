...
The workflow handles search, policy, escrow reservation, Duffel hold, ticketing pause, settlement, and invoice generation. Continue with [agent-to-agent booking](/docs/agent-to-agent-booking).
