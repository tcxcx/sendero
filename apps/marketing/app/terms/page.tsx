...
export const metadata = createPageMetadata({
  ...
  description:
    'Terms governing your use of Sendero, the travel support and trip operations product operated by Fantasmita LLC.',
  path: '/terms',
  og: {
  ...
  return (
    <LegalPage eyebrow="Legal" title="Terms of Service" effectiveDate="2026-04-28">
      <p>
        ...
        product operated by Fantasmita LLC ("we," "us"). By signing up for a workspace, minting an
        API key, or settling a booking through Sendero, you agree to these terms.
      </p>
