...
export function MarketingBrandHoverCard({
  locale,
  appOrigin,
}: {
  locale: string;
  ...
  const startFreeHref = `${appOrigin.replace(/\/$/, '')}/dashboard`;

  return (
    <HoverCard openDelay={120} closeDelay={80}>
      <HoverCardTrigger asChild>
        <a href={startFreeHref} aria-label={copy.kicker} className="mk-brand-hover-trigger">
      ...
      >
        ...
        <a className="mk-brand-hover-cta" href={startFreeHref}>
          {copy.ctaLabel}
        </a>
      </HoverCardContent>
    </HoverCard>
