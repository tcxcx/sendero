...
export function LandingHero() {
  ...
  const formValid =
    mode === 'login' ||
    (trimmedName.length > 0 && emailValid && phoneValid);
      ...
      <main className="hero-grid">
        <section className="hero-left">
          ...
          <h1 className="hero-title">
            An AI travel agent<br />
            that <em>books</em>, pays,<br />
            and <em>settles</em> itself.
          </h1>

          <p className="hero-sub">
            A B2B2C travel console. Employees book with a passkey-secured
            wallet, the agent issues a real PNR via Duffel, and the booking is
            settled on Arc Testnet through an ERC-8183 escrow job. No seed
            phrase, no native gas token — USDC is the gas.
          </p>
          ...
          >
            ...
            {!configured && (
              <div className="hero-alert">
                <strong>Passkey not configured.</strong>{' '}
                {configIssue ?? 'Check .env.local.'}
              </div>
            )}
            ...
            {mode === 'login' && (
              <p className="hero-login-hint">
                Use the passkey you registered on this device — biometric
                confirmation only.
              </p>
            )}
        ...
        <section className="hero-right">
          ...
          <div className="hero-right-caption">
            <span className="pulse" /> {MARKERS.length} hubs on Arc · idempotent
            hold · paymaster-sponsored userOps
          </div>
        </section>
      </main>
