...
export const boardingPassSchema = z.object({
  ...
  pnr: z
    .string()
    .nullable()
    .describe('6-character booking reference / record locator'),
  ticket_number: z.string().nullable().describe('13-digit airline ticket number if visible'),
  carrier_code: z
    .string()
    .nullable()
    .describe('2-letter IATA carrier code (e.g. AA, BA, LH)'),
  ...
  destination_iata: z
    .string()
    .nullable()
    .describe('3-letter IATA destination airport code'),
  departure_at: z
    .string()
    .nullable()
  ...
  sequence_number: z
    .string()
    .nullable()
    .describe('Boarding sequence / check-in order number'),
  frequent_flyer: z
    .string()
    .nullable()
    .describe('Frequent flyer number if visible'),
