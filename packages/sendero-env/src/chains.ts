 ...
 * Avalanche, Phase 4 = Solana) is a single-list change. The
 ...
 * SOL. Adding here doesn't auto-enable — see `getTenantTreasuryChains`
 * + `getTenantOperationsChains` below for the per-purpose toggles.
 */
